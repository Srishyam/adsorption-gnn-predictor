...
def define_global_variables_moments():
	''' 
	etas_vector:
	eta_ss_sig = etas_vector[0] = -1.32 or -1.40
	eta_sp_sig = etas_vector[1] = 1.42
	eta_ds_sig = etas_vector[2] = -1.83 or -3.16
	...
	eta_dd_sig = etas_vector[7] = -45/math.pi or -16.2
	eta_dd_pi = etas_vector[8] = 30/math.pi or 8.75
	eta_dd_delta = etas_vector[9] = -15/(2*math.pi) or 0
	'''
